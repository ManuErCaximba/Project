...
<security:authorize access="hasRole('ADMIN')">
    ...
    <form:form id="presentation" action="presentation/administrator/save.do" modelAttribute="presentation">
        ...
        <fieldset>
            ...
            <legend><spring:message code="presentation.submission" /></legend>

            <form:select path="submission" items="${submissions}"/>
